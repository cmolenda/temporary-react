Goals:
* Make Response sections have the same value
* Make the "expensive calculation" only get called once
* Factor out redundant code and make any clean up improvements you see fit
* Reduxify/Refluxify the code
